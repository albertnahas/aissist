...
## Purpose
Provides contextual hints after command execution to guide users toward logical next steps, improving discoverability and workflow efficiency through AI-powered and static fallback suggestions.
